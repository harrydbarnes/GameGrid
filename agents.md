...
- Game state, settings and stats are local to each browser. Do not imply cloud sync, shared accounts or cross-device persistence unless those features are explicitly added.
